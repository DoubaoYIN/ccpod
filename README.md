...
- 🎨 macOS menu bar app (native Swift) — launcher + session monitor
...
- 🪟 Per-window provider isolation — different windows can use different providers
- 📋 Session registry — tracks all running CC instances
